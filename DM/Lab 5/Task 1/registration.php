<form method="POST" action="notification.php" name="myForm" enctype="multipart/form-data" required>
	<table border="1">
		<tr>
		...
		<tr>
			<td colspan="1">*Interested in:</td>
			<td colspan="2"><input type="checkbox" name="in[]" value="Interested">Training &nbsp<input type="checkbox" name="in[]" value="Interested">Placement</td>
		</tr>
		<tr>
